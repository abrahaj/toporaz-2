...
<html>
    ...
    <body>
        ...
        <div id="show-profession" class="content scaffold-show" role="main">
            ...
            <f:display bean="profession" />
            <g:form resource="${this.profession}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.profession}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
